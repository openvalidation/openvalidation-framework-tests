...
public class ValidatorWithAmountWithMultipleVars implements HUMLFramework.IOpenValidator
{
    ...
    public ValidatorWithAmountWithMultipleVars()
    {
        ...
        HUMLFramework.Variable firstFilter = huml.CreateVariable("firstfilter", (FirstTestModel model) -> huml.FIRST(array.GetValue(model), 2));
        HUMLFramework.Variable secondFilter = huml.CreateVariable("secondfilter", (FirstTestModel model) -> huml.FIRST(firstFilter.GetValue(model), 2));

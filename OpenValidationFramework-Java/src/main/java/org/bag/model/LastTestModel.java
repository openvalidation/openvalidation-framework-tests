...
public class LastTestModel {
    ...
    public LastTestModel withNumbers(List<Integer> numbers) {
        this.numbers = numbers;
        return this;
    }
    ...
    public LastTestModel withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LastTestModel) == false) {
            return false;
        }
        LastTestModel rhs = ((LastTestModel) other);

...
{
    public class FirstFunctionOnVariableContainingAVariableContainingAnArrayValidator : HUMLFramework.IOpenValidator
    {
        public HUMLFramework huml;

        public FirstFunctionOnVariableContainingAVariableContainingAnArrayValidator()
        {
